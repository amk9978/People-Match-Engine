...
class DatasetModificationService:
    ...
    def add_rows(self, user_id: str, filename: str, modification: DatasetModification) -> DatasetVersion:
        """Add rows to dataset"""
        ...
        new_version = DatasetVersion.create_modification(
            ...
            description=modification.description or f"Added {len(modification.rows)} rows"
        )
    ...
    def delete_rows_by_indices(self, user_id: str, filename: str, 
                              row_indices: List[int], description: str = None) -> DatasetVersion:
    ...
    def delete_rows_by_criteria(self, user_id: str, filename: str, 
                               criteria: DatasetDeletionCriteria) -> DatasetVersion:
        ...
        new_version = DatasetVersion.create_modification(
            ...
            file_path="",
            description=criteria.description or f"Deleted {deleted_count} rows matching criteria"
        )
    ...
    def revert_to_version(self, user_id: str, filename: str, 
                         target_version_id: str, description: str = None) -> DatasetVersion:
        ...
        # Load target version
        target_df = self.dataset_repository.load_dataframe(user_id, filename, target_version_id)
