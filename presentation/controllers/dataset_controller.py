...
from presentation.models.dataset_models import (
    AddRowsRequest, DeleteRowsRequest, DeleteRowsByCriteriaRequest,
    DatasetInfoResponse, DatasetPreviewResponse, DatasetModificationResponse,
    VersionDiffResponse, DatasetListResponse
)
...
class DatasetController:
    ...
    def _register_routes(self):
        ...
        @self.router.post("/{filename}/add-rows", response_model=DatasetModificationResponse)
        ...
        @self.router.post("/{filename}/delete-rows", response_model=DatasetModificationResponse)
        ...
        @self.router.post("/{filename}/delete-rows-by-criteria", response_model=DatasetModificationResponse)
        ...
        @self.router.post("/{filename}/revert/{version_id}", response_model=DatasetModificationResponse)
        ...
        async def get_version_diff(
            ...
            try:
                diff = self.dataset_service.get_version_diff(user_id, filename, version1, version2)
